...
class FormatoTicket
{
    public static function generar($params)
    {
        ...
        if ($descuentos['SumaDeDescuentos'] != 0) {
        ...
        if ($reimpresion['fechacertificacion'] != '') {
            $pdf->multiCell(0, 1, 'Fecha de certificación: ' . $reimpresion['fechacertificacion'], 0, 'L', 0, 1, 5, $y, true, 0);
        }
